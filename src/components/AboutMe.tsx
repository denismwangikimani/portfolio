...
const AboutMe: React.FC = () => {
  return (
    <div className="relative min-h-screen w-full text-black bg-white p-8">
      <div className="max-w-4xl mx-auto relative mt-32">
        <h1 className="text-6xl sm:text-7xl md:text-8xl lg:text-9xl mb-4 relative font-bold">
          ...
          <span className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-lime-400">
            !
          </span>
        </h1>
            ...
            <div className="flex-1">
              ...
              >
                <span className="text-xl sm:text-1xl">
                  ...
                  <span>
                  <span className="text-2xl sm:text-2xl font-extrabold">
                      A
                    </span>
                    <span className="text-lg sm:text-1xl">PPS</span>
                  </span>
                </span>
              </div>
            </div>

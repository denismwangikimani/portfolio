...
const undeadPurgeScreenshots: Screenshot[] = [
  ...
  { src: "/images/undead-purge-screenshots/wasted.png", alt: "Screenshot 5" },
];

const UndeadPurgePage: React.FC = () => {
  return (
      ...
      <main className="container mx-auto px-4 md:px-6 lg:px-8 max-w-4xl py-16 md:py-24">
        ...
        <section className="space-y-8 mb-16">
          ...
          <p className="text-lg md:text-xl leading-relaxed text-center text-gray-600">
            An intense zombie survival FPS game set in a desert apocalypse.
            Built using Unity and C#, the game challenges you to survive waves
            of undead enemies.
          </p>
          <video
            className="w-full h-auto rounded-lg shadow-md"
            src="/videos/undead-purge-demo-video - Made with Clipchamp.mp4"
            autoPlay
            loop
            muted
            playsInline
        ...
        <section className="space-y-8 mb-16">
          ...
          <p className="text-lg md:text-xl leading-relaxed text-gray-700">
            <em>Undead Purge</em> is a zombie wave survival game set in a
            sprawling desert environment. Players must collect weapons and
            resources to fend off increasingly challenging waves of zombies.
            Each wave doubles the number of enemies, requiring strategy,
            precision, and resource management to survive.
          </p>
        </section>
        ...
        <section className="space-y-8 mb-16">
          ...
          <ul className="list-disc list-inside text-lg md:text-xl leading-relaxed text-gray-700 space-y-2">
            ...
            <li>
              Multiple weapon types: pistol, rifle, grenades, smoke grenades.
            </li>
            <li>
              Wave-based zombie survival where enemy numbers double each round.
            </li>
            <li>
              Responsive controls: walk, jump, reload, and weapon switching.
            </li>
        ...
        <section className="space-y-8 mb-16">
          ...
          <ol className="list-decimal list-inside text-lg md:text-xl leading-relaxed text-gray-700 space-y-2">
            <li>
              Download the game project folder from the Google Drive link above.
            </li>
            ...
            <li>
              Press the &quot;Play&quot; button in Unity to test and play the
              game.
            </li>
          </ol>
        </section>

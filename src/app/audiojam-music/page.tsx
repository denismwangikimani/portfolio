...
const audioJamScreenshots: Screenshot[] = [
  {
    src: "/images/audiojam-screenshots/landingpage_upscaled_464x259.jpg",
    alt: "Screenshot 1",
  },
  {
    src: "/images/audiojam-screenshots/login_upscaled.png",
    alt: "Screenshot 2",
  },
  { src: "/images/audiojam-screenshots/billboard.png", alt: "Screenshot 3" },
  { src: "/images/audiojam-screenshots/top.png", alt: "Screenshot 4" },
  { src: "/images/audiojam-screenshots/roast.png", alt: "Screenshot 5" },
];

const AudioJamPage: React.FC = () => {
  return (
      ...
      <main className="container mx-auto px-4 md:px-6 lg:px-8 max-w-4xl py-16 md:py-24">
        ...
        <section className="space-y-8 mb-16">
          ...
          <p className="text-lg md:text-xl leading-relaxed text-center text-gray-600">
            AudioJam Spotify is a web application integrating with the Spotify
            API to deliver a personalized and interactive music experience.
          </p>
          <video
        ...
        <section className="space-y-8 mb-16">
          ...
          <p className="text-lg md:text-xl leading-relaxed text-gray-700">
            AudioJam Spotify is a feature-rich platform enabling users to
            explore their music preferences, manage playlists, and receive
            personalized recommendations in a fun and interactive way.
          </p>
        </section>
        ...
        <section className="space-y-8 mb-16">
          ...
          <ul className="list-disc list-inside text-lg md:text-xl leading-relaxed text-gray-700 space-y-2">
            <li>
              Secure user authentication using Spotify&apos;s OAuth system.
            </li>
            <li>
              Comprehensive playlist management, including creating and saving
              playlists.
            </li>
            <li>
              Search tracks, albums, and artists with song recommendations.
            </li>
            <li>
              Analyze audio features such as tempo, energy, and danceability.
            </li>
            <li>
              Integrate humor using the Gemini API for music taste roasts.
            </li>
            <li>
              Display Billboard Hot 100 and metadata from Last.fm and
              MusicBrainz.
            </li>
          </ul>
        </section>

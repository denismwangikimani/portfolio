...
//   {
//     src: "/images/menu-planner-screenshots/mobile.png",
//     alt: "Mobile View",
//   },
];
      ...
      <main className="container mx-auto px-4 md:px-6 lg:px-8 max-w-4xl py-16 md:py-24">
        ...
        <section className="space-y-8 mb-16">
          ...
          <p className="text-lg md:text-xl leading-relaxed text-center text-gray-600">
            A comprehensive meal planning application built with React, TypeScript, and Node.js
            that automates menu scheduling while accommodating dietary restrictions and allergies.
          </p>
          <video
        ...
        <section className="space-y-8 mb-16">
          ...
          <p className="text-lg md:text-xl leading-relaxed text-gray-700">
            The Menu Scheduling App was developed as part of Chingu Voyage 53, a collaborative 
            development program. Our team of 3 developers and 2 scrum masters worked together 
            using Agile methodologies to build this solution from concept to deployment over 
            a 6-week sprint.
          </p>
        </section>
        ...
        <section className="space-y-8 mb-16">
          ...
          <ul className="list-disc list-inside text-lg md:text-xl leading-relaxed text-gray-700 space-y-2">
            <li>
              User authentication with secure JWT sessions and social login options (Google, GitHub)
            </li>
            <li>
              Allergy tracking system that filters out dishes containing allergens
            </li>
            <li>
              Automated menu generation using dietary preferences and restrictions
            </li>
            <li>
              Manual menu scheduling with customizable meal plans
            </li>
            <li>
              PDF export functionality for offline access to weekly menus
            </li>
            <li>
        ...
        <section className="space-y-8 mb-16">
          ...
          <ul className="list-disc list-inside text-lg md:text-xl leading-relaxed text-gray-700 space-y-2">
            <li>
              <strong>MongoDB Atlas:</strong> NoSQL database for flexible data storage and retrieval of user profiles, menus, and allergies
            </li>
            <li>
              <strong>TheMealDB API:</strong> External service for accessing diverse meal recipes and ingredients
            </li>
            <li>
              <strong>JWT Authentication:</strong> Secure token-based authentication for protected routes and API access
            </li>
            <li>
              <strong>PDFKit:</strong> PDF generation library for exporting weekly menus in document format
            </li>
            <li>
              <strong>Passport.js:</strong> Authentication middleware supporting multiple OAuth strategies
            </li>
            <li>
              <strong>Tailwind CSS:</strong> Utility-first CSS framework for responsive and customizable UI components
            </li>
          </ul>
        </section>
          ...
          <ol className="list-decimal list-inside text-lg md:text-xl leading-relaxed text-gray-700 space-y-2">
            <li>
              ...
              <code className="bg-gray-100 px-1 py-0.5 rounded block mt-2 ml-6">
                git clone https://github.com/chingu-voyages/V53-tier3-team-32.git<br />
